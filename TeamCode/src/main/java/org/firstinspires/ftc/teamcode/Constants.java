...
public final class Constants {
    ...
    /** Hardware map names for the drivetrain. */
    ...
    // === Flywheel control ===
    /**
     * Feedforward constant.  Multiplies the target RPM to produce a base motor
     * power.  This value should be tuned on the real robot.  Start by
     * measuring the RPM at full power and then compute 1 / maxRPM.
     */
    public static final double FLY_KF = 0.00013;
    /** Proportional gain for fine adjustments around the target flywheel RPM. */
    public static final double FLY_KP = 0.0006;
    ...
    public static final double FLY_BB_THRESH_RPM = 150.0;
    /** Maximum power applied to the flywheel motor. */
    public static final double FLY_MAX_POWER = 1.0;
    /** Convenient default RPM for testing the flywheel. */
    public static final double FLY_TEST_RPM = 5000.0;
